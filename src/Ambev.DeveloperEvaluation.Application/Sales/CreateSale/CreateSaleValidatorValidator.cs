...
public class CreateSaleCommandValidator : AbstractValidator<CreateSaleCommand>
{
    public CreateSaleCommandValidator()
    {
        ...
        RuleForEach(x => x.Products)
            .SetValidator(new SaleProductCommandValidator());
    }
}

public class SaleProductCommandValidator : AbstractValidator<CreateSaleProductCommand>
{
    public SaleProductCommandValidator()
    {
        ...
        RuleFor(x => x.Quantity)
            ...
            .WithMessage("Não é possível vender mais de 20 unidades do produto");
